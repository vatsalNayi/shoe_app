...
class WishedItems extends StatelessWidget {
  // final ProductModel productData; // TODO: uncomment
  final int index;
  const WishedItems({
    Key? key,
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            BoxShadow(
                color: Colors.black12, blurRadius: 5, offset: Offset(3, 5)),
          ],
        ),
        child: Stack(
          children: [
                ...
                children: [
                  ClipRRect(
                    ...
                    child: CustomImage(
                      ...
                      image: '',
                      placeholder: ImagePath.wishedItem1,
                      height: 240,
            ...
            Positioned.fill(
              ...
              child: Align(
                ...
                child: GestureDetector(
                  onTap: () {
                    Get.find<WishListController>().removeProductWishlist(index);
                  },
                  child: Container(
                    width: 20.w,
                    height: 20.h,
