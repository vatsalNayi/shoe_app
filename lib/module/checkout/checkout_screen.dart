...
import 'package:shoes_app/global_widgets/custom_button_comp.dart';
            ...
            return GetBuilder<OrderController>(builder: (orderController) {
              ...
              return
                ...
                children: [
                          ...
                          children: [
                            ...
                            Get.find<ConfigController>().payment.isEmpty
                                ...
                                : SizedBox(
                                    ...
                                    child: ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: Get.find<ConfigController>()
                                          .payment
                                          .length,
                                      ...
                                      itemBuilder: (context, index) {
                                        return PaymentButton(
                                          isSelected: orderController
                                                  .paymentMethodIndex ==
                                              index,
                                          title: Get.find<ConfigController>()
                                              .payment[index]
                                              .title
                                              .tr,
                                          subtitle: Get.find<ConfigController>()
                                              .payment[index]
                                              .description
                                              .tr,
                                          icon: Get.find<ConfigController>()
                                              .payment[index]
                                              .icon,
                            ...
                            ResponsiveHelper.isDesktop(context)
                                ? Padding(
                                    ...
                                    child: _orderPlaceButton(orderController,
                  ...
                  _orderPlaceButton(
                      orderController, profileController, locationController),
                ],
              );
